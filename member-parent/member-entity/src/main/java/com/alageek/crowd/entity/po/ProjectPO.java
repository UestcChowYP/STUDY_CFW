package com.alageek.crowd.entity.po;
...
public class ProjectPO {
    ...
    public ProjectPO(Integer id, String projectName, String projectDescription, Long money, Integer day, Integer status, String deploydate, Long supportmoney, Integer supporter, Integer completion, Integer memberid, String createdate, Integer follower, String headerPicturePath) {
        this.id = id;

...
import com.alageek.crowd.config.OSSProperties;
...
public class ProjectConsumerHandler {
    ...
    public String saveConfirm(ModelMap modelMap, HttpSession session, MemberConfirmInfoVO memberConfirmInfoVO) {
        ...
        return "redirect:"+ CrowdConstant.ATTR_NAME_ZUUL +"/project/create/success/page";
    }
    ...
    public String saveProjectBasicInfo(
        ...
        return "redirect:"+ CrowdConstant.ATTR_NAME_ZUUL +"/project/return/info/page";
    }

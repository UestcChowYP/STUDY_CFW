...
function getPageInfoRemote() {
    ...
    // 发生错误 判断当前响应状态码是否为200
    if (statusCode != 200) {
        layer.msg("服务器端程序调用失败！响应状态码是=" + statusCode + "说明信息=" + ajaxResult.statusText);
        return null;
    }
    // 如果响应状态码是200表示请求成功
...
function fillTableBody(pageInfo) {
    ...
    if (pageInfo == null || pageInfo == undefined || pageInfo.list.length == 0) {
        $("#rolePageBody").append("<tr align=\"center\"><td colspan='4'>抱歉！没有查询到您要的数据！</td></tr>");
        return;
    }
